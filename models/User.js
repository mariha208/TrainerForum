...
const userSchema = new mongoose.Schema(
  {
    ...
    expertiseCategory1: { type: String, default: '' },
    expertiseCategory2: { type: String, default: '' },
    expertiseCategory3: { type: String, default: '' },
    skills:            [{ type: String }],
    ...
    customBlockedDates: { type: [String], default: [] },
