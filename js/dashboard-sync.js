...
async function saveTrainerProfile() {
  ...
  const payload = {
    ...
    expertiseCategory1: TDB_STATE.expertiseCategory1 || tdbGet('tdb-category'),
    expertiseCategory2: TDB_STATE.expertiseCategory2 || '',
    expertiseCategory3: TDB_STATE.expertiseCategory3 || '',
  ...
  const profileSnapshot = JSON.stringify({
    ...
    category1: payload.expertiseCategory1,
    category2: payload.expertiseCategory2,
    category3: payload.expertiseCategory3,
