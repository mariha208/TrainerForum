 ...
 */
window.isDateBlocked = function (dateObj, availability) {
  if (!availability) return false;

  // 1. Format date into local YYYY-MM-DD string
  ...
  if (typeof document !== 'undefined') {
    ...
    if (cont) {
      ...
      if (matchRow) {
        const toggleEl = matchRow.querySelector('.avail-toggle');
        if (toggleEl && !toggleEl.checked) return true;
      }
    }
  }
  ...
  if (dayConfig) {
    if (dayConfig.enabled === false || dayConfig.available === false) return true;
    if (dayConfig.enabled === true || dayConfig.available === true) return false;
  }
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  <div>
                    <div style="display: flex; gap: 8px; align-items: center; margin-bottom: 3px;">
                      <a href="${waHref}" target="_blank" rel="noopener" onclick="event.stopPropagation()" title="WhatsApp" style="color: #25d366; background: rgba(37,211,102,0.12); width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; transition: transform 0.18s, box-shadow 0.18s; flex-shrink: 0;" onmouseover="this.style.transform='scale(1.15)'; this.style.boxShadow='0 2px 10px rgba(37,211,102,0.3)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='none';">
                      ...
                      <a href="${liHref}" target="_blank" rel="noopener" onclick="event.stopPropagation()" title="LinkedIn" style="color: #0a66c2; background: rgba(10,102,194,0.12); width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; transition: transform 0.18s, box-shadow 0.18s; flex-shrink: 0;" onmouseover="this.style.transform='scale(1.15)'; this.style.boxShadow='0 2px 10px rgba(10,102,194,0.3)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='none';">
                      ...
                      <a href="${webHref}" target="_blank" rel="noopener" onclick="event.stopPropagation()" title="Website" style="color: #c5a059; background: rgba(197,160,89,0.12); width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; transition: transform 0.18s, box-shadow 0.18s; flex-shrink: 0;" onmouseover="this.style.transform='scale(1.15)'; this.style.boxShadow='0 2px 10px rgba(197,160,89,0.3)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='none';">
